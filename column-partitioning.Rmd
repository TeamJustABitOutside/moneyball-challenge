...
mb_game_data <- select(mb, RECORDNUM, 
                       ACTUAL_PTS, Week, DayNight, 
                       HitterStatus, PlayToday_Likelihood, 
                       `Hitter Pos`, `Fanduel Pos`, BOP, 
                       HitterHomeAway, PitcherSide, `Hitter-Pitcher B-T`) %>%
